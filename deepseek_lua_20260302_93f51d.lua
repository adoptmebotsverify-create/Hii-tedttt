...
-- Properly rains multiple pets and works every time
...
-- ==============================================
-- RAIN PET FUNCTION - FIXED TO CREATE MULTIPLE PETS
-- ==============================================
...
-- FIXED RAIN FUNCTION - Now works every time
...
-- Rain button - FIXED: Now works every time
rainButton.MouseButton1Click:Connect(function()
    -- Don't allow clicking while already raining
...
print("✅ FIXED Rain Pet GUI loaded!")
print("📊 Total pets available: " .. #AllPets)
print("🌈 MFR | 🌟 NFR | 🪽 FR | ⚪ Regular")
print("🖱️ Click MAKE IT RAIN for multiple pets!")